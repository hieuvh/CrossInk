...
By default, to keep the DRAM footprint minimal on the ESP32-C3, only **English** is compiled into the main firmware. However, the system is designed to be fully customizable, and other languages can be easily added and generated via the translation generator script.
